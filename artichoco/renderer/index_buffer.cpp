...
IndexBuffer detail::BufferAccess::createIndexBuffer(vulkan::VulkanAllocator& allocator,
        vulkan::VulkanUploadContext& upload_context, DeferredResourceOwnerPtr owner,
